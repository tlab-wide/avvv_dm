...
#ifndef VISUALLY_DM__POINTCLOUD_TOOLS_HPP_
#define VISUALLY_DM__POINTCLOUD_TOOLS_HPP_
...
public:
     ...
     * 'world' or 'map'
     */
    PointcloudTools(rclcpp::Node& node, const std::string& base_frame);
...
private:
     ...
     * @param offset
     */
    void applyOffset(pcl::PointCloud<pcl::PointXYZ>& cloud, const double offset[3]);
