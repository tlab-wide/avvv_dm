...
#ifndef VISUALLY_DM__TRANSFORMS_HPP_
#define VISUALLY_DM__TRANSFORMS_HPP_
...
/**
 * @brief Create the corresponding rviz_visual_tools::Colors colour based on the given colour name
 * @param colour
 * @returns Enumerator corresponding to the colour name
 */
rviz_visual_tools::Colors getRvizColour(const std::string& colour);

/**
 * @brief Create geometry_msgs::msg::Pose base on the given position and orientation values
 * @param position
 * @param orientation
 * @param pose
 */
...
/**
 * @brief Converts geographic to MGRS
 * @param lon Longitude
 * @param lat Latitude
 * @param x MGRS x
 * @param y MGRS y
