...
class Conf:
    ...
    def __init__(self, config_file_name: str = "conf.ini"):
        ...
        Conf.just_show_packet_loss = Conf.boolean(
            json.loads(configur.get("position_reporter_packet_loss", "just_show_packet_loss")))
        Conf.packet_loss_point_size = json.loads(
            configur.get("position_reporter_packet_loss", "packet_loss_point_size"))
        ...
        Conf.cpm_format_perceived_objects_number = json.loads(
            configur.get("csv_files", "cpm_format_perceived_objects_number"))
